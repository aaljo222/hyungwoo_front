// import { makeCommonDiscList } from "./makeCommonList";
...
const makeCommonDiscList = (items, columns = 1) => {
  const wrapperClass = columns === 2 ? "grid grid-cols-2 gap-x-4" : "space-y-1";
...
const makeCommonCircledNumberList = (items = [], startIdx = 0) => {
  const numberIcons = ["①", "②", "③", "④", "⑤", "⑥", "⑦", "⑧", "⑨", "⑩"];
...
export {
  makeCommonDiscList,
  makeCommonNumberList,
  makeCommonKoreaList,
  makeDefaultLI,
  makeCommonCircledNumberList,
};
